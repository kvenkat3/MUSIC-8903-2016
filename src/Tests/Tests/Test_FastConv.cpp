...
SUITE(FastConv)
{
    struct FastConvData
    {
        ...
        void TestProcess()
        {
           ...
           if (m_iDataLength < m_iBlockLength){
                m_iNumBufferZeros = m_iBlockLength - m_iDataLength;
                CVectorFloat::setZero(&m_pfInputData[m_iBlockLength - m_iNumBufferZeros], m_iNumBufferZeros);
            }
